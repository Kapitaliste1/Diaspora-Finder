 ...
 */
public class CardViewGroupsAdapter extends RecyclerView.Adapter<CardViewGroupsAdapter.ViewHolder> {
    ...
    public CardViewGroupsAdapter(Context context,List<Posts> postsBackendlessCollection,Activity application) {
    ...
    @Override
    public CardViewGroupsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        Toast.makeText(holder.mView.getContext(), "From card!", Toast.LENGTH_LONG).show();
